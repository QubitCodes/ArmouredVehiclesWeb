...
const orderData = {
  ...
  tracking: [
    ...
    },
    {
      ...
      onTime: true,
      message:
        "Your shipment has been dispatched to the final hub. We'll notify you once it's out for delivery. When your order is almost there, we'll display the courier's contact number.",
    },
    {
...
export default function TrackOrder({ orderId }: TrackOrderProps) {
  ...
  return (
    <div className="flex-1">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h2 className="font-orbitron font-bold text-sm uppercase tracking-wider text-black mb-3">
              Delivery Address{" "}
              <span className="text-[#666] font-normal normal-case">(Work)</span>
            </h2>
      ...
      <div 
        className="bg-[#EBE3D6] p-4 lg:p-5 mb-4 cursor-pointer hover:bg-[#E0D9CC] transition-colors"
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm text-[#D35400] hover:underline font-medium">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-[#666] mt-1">
                Only packed individual items cannot be cancelled.
              </p>
            </div>
