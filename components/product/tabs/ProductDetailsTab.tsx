            ...
            <div className="mb-4">
                 ...
                 <div className="flex items-start gap-2 text-[10px] text-gray-700">
                     ...
                     <p>
                        ...
                        <a href="#" className="text-blue-600 hover:underline ml-1">www.p65warnings.ca.gov</a>
                     </p>
                 </div>
            </div>

            <div className="grid grid-cols-2 max-w-sm gap-y-1 text-[10px] text-gray-500 mt-6">
                <div>Part Number:</div>
